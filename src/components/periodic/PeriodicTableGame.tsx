  ...
  if (!started) {
    return (
      <div className="flex flex-col gap-6">
        ...
        <button
          onClick={() => { setStudyOpen(false); setStarted(true); }}
          className="self-start px-6 py-3 rounded-xl bg-indigo-600 text-white font-semibold hover:bg-indigo-500 transition-colors"
        >
          Play
        </button>
